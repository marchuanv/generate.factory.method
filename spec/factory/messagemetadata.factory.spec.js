...
describe('when asking the MessageMetadata factory to create an instance', function() {
  it("it should succeed without any errors", function() {
    // Arrange
    const {scopeId,metadata,recipientHost,recipientPort,senderHost,senderPort,token,recipientAddress,senderAddress} = require('C:\\component\\spec\\factory\\messagemetadata.factory.spec.variables.json');
