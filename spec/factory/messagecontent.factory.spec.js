...
describe('when asking the MessageContent factory to create an instance', function() {
  it("it should succeed without any errors", function() {
    // Arrange
    const {scopeId,data,metadata,recipientHost,recipientPort,senderHost,senderPort,token,userSessions,recipientAddress,senderAddress} = require('C:\\component\\spec\\factory\\messagecontent.factory.spec.variables.json');
