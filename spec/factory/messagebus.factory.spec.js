...
describe('when asking the MessageBus factory to create an instance', function() {
  it("it should succeed without any errors", function() {
    // Arrange
    const {messageQueueTypeCode,channel,recipientHost,recipientPort,senderHost,senderPort,token,sharedMessageQueue,sharedUserSessions,recipientAddress,messageHandlerQueue,senderAddress} = require('C:\\component\\spec\\factory\\messagebus.factory.spec.variables.json');
