...
describe('when asking the MessageBus factory to create an instance', function() {
  it("it should succeed without any errors", function() {
    ...
    // Act
    const {messageBus} = createMessageBus({token,messageQueueTypeCode,messageQueueArray,recipientHost,recipientPort,userId,senderHost,senderPort,data,metadata,messageStatusCode,channelName});
    // Assert
