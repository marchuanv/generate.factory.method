...
describe('when asking the ServerMessageBus factory to create an instance', function() {
  it("it should succeed without any errors", function() {
    // Arrange
    const {scopeId,senderHost,senderPort,timeout,httpServerResponseMessageBus,httpServerRequestMessageBus} = require('C:\\component\\spec\\factory\\servermessagebus.factory.spec.variables.json');
