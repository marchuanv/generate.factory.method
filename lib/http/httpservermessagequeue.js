function HttpServerMessageQueue({ sharedMessageQueue, sharedMessageConverter, messageQueueContextId }) {
    ...
    {
        const { eventSubscription } = createEventSubscription({ eventCode: 3, subscriptionName: 'HttpServerMessageQueue' });
    ...
    {
        const { eventSubscription } = createEventSubscription({ eventCode: 9, subscriptionName: 'HttpServerMessageQueue' });
        eventSubscription.subscribe({ callback: () => {
