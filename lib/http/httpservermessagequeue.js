function HttpServerMessageQueue({ sharedMessageQueue, sharedMessageConverter, messageQueueContextId }) {
    ...
    {
        const { eventSubscription } = createEventSubscription({ messageQueueContextId, eventCode: 3, subscriptionName: 'HttpServerMessageQueue' });
    ...
    {
        const { eventSubscription } = createEventSubscription({ messageQueueContextId, eventCode: 9, subscriptionName: 'HttpServerMessageQueue' });
        eventSubscription.subscribe({ callback: () => {
