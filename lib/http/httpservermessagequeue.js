function HttpServerMessageQueue({ sharedMessageQueue, userId, senderAddress, recipientAddress }) {
    ...
    Object.defineProperty(this, 'enqueueHttpRequest', { configurable: false, writable: false, value: ({ httpRequest, refId }) => {
        ...
        sharedMessageQueue.queueMessage({ message: httpRequestMessage, messageQueueType: 'HttpServerRequestMessage', refId });
        return { refId };
    }});
    Object.defineProperty(this, 'enqueueHttpResponseMessage', { configurable: false, writable: false, value: ({ responseMessage, refId }) => {
        ...
        sharedMessageQueue.queueMessage({ message: httpResponseMessage, messageQueueType: 'HttpServerResponseMessage', refId });
        return { refId };
    }});
    Object.defineProperty(this, 'dequeueHttpRequestMessage', { configurable: false, writable: false, value: async () => {
        const { message, refId }  = await sharedMessageQueue.dequeueMessage({ messageQueueType: 'HttpServerRequestMessage' });
    ...
    Object.defineProperty(this, 'dequeueHttpResponseMessage', { configurable: false, writable: false, value: async () => {
        const { message, refId }  = await sharedMessageQueue.dequeueMessage({ messageQueueType: 'HttpServerResponseMessage' });
