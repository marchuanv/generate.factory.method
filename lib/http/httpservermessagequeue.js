function HttpServerMessageQueue({ sharedMessageQueue, sharedMessageConverter, contextId }) {
    ...
    {
        const { eventSubscription } = createEventSubscription({ contextId, eventCode: 3, subscriptionName: 'HttpServerMessageQueue' });
    ...
    {
        const { eventSubscription } = createEventSubscription({ contextId, eventCode: 9, subscriptionName: 'HttpServerMessageQueue' });
        eventSubscription.subscribe({ callback: () => {
