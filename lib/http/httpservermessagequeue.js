function HttpServerMessageQueue({ sharedMessageQueue, sharedMessageConverter, messageQueueType, userId, senderAddress, recipientAddress }) {
    ...
    Object.defineProperty(this, 'enqueueHttpRequest', { configurable: false, writable: false, value: async ({ httpRequest }) => {
        ...
        const { token, base64rsapublickey } = httpRequest.headers;
