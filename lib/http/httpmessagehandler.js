...
function HttpMessageHandler({ httpMessageFactory, httpConnection, httpRequestQueue, httpResponseQueue, hostAddress }) {
    ...
    Object.defineProperty(this, 'receive', { writable: false, value: async ({ recipientAddress, callback }) => {
...
HttpMessageHandler.prototype.receive = function({ recipientAddress, callback }) { };
