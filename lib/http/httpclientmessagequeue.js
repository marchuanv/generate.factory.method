function HttpClientMessageQueue({ sharedMessageQueue, sharedMessageConverter, messageQueueContextId }) {
    ...
    {
        const { eventSubscription } = createEventSubscription({ messageQueueContextId, eventCode: 3, subscriptionName: 'HttpClientMessageQueue' });
    ...
    {
        const { eventSubscription } = createEventSubscription({ messageQueueContextId, eventCode: 9, subscriptionName: 'HttpClientMessageQueue' });
        eventSubscription.subscribe({ callback: () => {
