function HttpClientMessageQueue({ sharedMessageQueue, sharedMessageConverter, messageQueueContextId }) {
    ...
    {
        const { eventSubscription } = createEventSubscription({ eventCode: 3, subscriptionName: 'HttpClientMessageQueue' });
    ...
    {
        const { eventSubscription } = createEventSubscription({ eventCode: 9, subscriptionName: 'HttpClientMessageQueue' });
        eventSubscription.subscribe({ callback: () => {
