function HttpClientMessageQueue({ sharedMessageQueue, sharedMessageConverter, contextId }) {
    ...
    {
        const { eventSubscription } = createEventSubscription({ contextId, eventCode: 3, subscriptionName: 'HttpClientMessageQueue' });
    ...
    {
        const { eventSubscription } = createEventSubscription({ contextId, eventCode: 9, subscriptionName: 'HttpClientMessageQueue' });
        eventSubscription.subscribe({ callback: () => {
