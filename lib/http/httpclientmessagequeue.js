function HttpClientMessageQueue({ sharedMessageQueue, userId, senderAddress, recipientAddress }) {
    ...
    Object.defineProperty(this, 'enqueueHttpResponse', { configurable: false, writable: false, value: ({ httpResponse }) => {
        ...
        sharedMessageQueue.queueMessage({ message: httpResponseMessage, messageType: 'HttpResponseMessage' });
    }});
    Object.defineProperty(this, 'enqueueHttpRequestMessage', { configurable: false, writable: false, value: ({ requestMessage }) => {
        ...
        sharedMessageQueue.queueMessage({ message: httpRequestMessage, messageType: 'HttpRequestMessage' });
    }});
    Object.defineProperty(this, 'dequeueHttpRequestMessage', { configurable: false, writable: false, value: async () => {
        const { message }  = await sharedMessageQueue.dequeueMessage({ messageType: 'HttpRequestMessage' });
    ...
    Object.defineProperty(this, 'dequeueHttpResponseMessage', { configurable: false, writable: false, value: async () => {
        const { message }  = await sharedMessageQueue.dequeueMessage({ messageType: 'HttpResponseMessage' });
