function HttpClientMessageQueue({ sharedMessageQueue, sharedMessageConverter, messageQueueContextId }) {
    ...
    {
        const { eventSubscription } = createEventSubscription({ eventCode: 3, eventSource: 'HttpClientMessageQueue', eventDescription: 'Http Message Bus Started' });
    ...
    {
        const { eventSubscription } = createEventSubscription({ eventCode: 9, eventSource: 'HttpClientMessageQueue', eventDescription: 'Http Message Bus Stopped' });
        eventSubscription.subscribe({ callback: () => {
