...
function HttpMessageFactory({ messageFactory }) {
    ...
    Object.defineProperty(this, 'createHttpRequestMessage', { writable: false, value: ({ address, data, headers, messageStatus }) => {
        const message = messageFactory.create({ address, data, metadata: headers, messageStatus: messageStatus || new MessageStatus({ code: 2 })});
...
HttpMessageFactory.prototype.createHttpRequestMessage = function({ address, data, headers, messageStatus }) {}
