...
function HttpMessageFactory({ messageFactory, encryption, errorMessages }) {
    ...
    Object.defineProperty(this, 'createHttpRequestMessage', { writable: false, value: ({ fromHost, data, headers  }) => {
        ...
        return new HttpRequestMessage({ message, errorMessages });
    }});
    Object.defineProperty(this, 'createHttpResponseMessage', { writable: false, value: ({ fromHost, data, headers, messageStatus }) => {
        const content = new Content({ data, metadata: headers, encryption });
        const message = messageFactory.create({ fromHost, content, messageStatus });
        return new HttpResponseMessage({ message, errorMessages });
    }});
...
HttpMessageFactory.prototype.createHttpRequestMessage = function({ fromHost, data, headers }) {}
HttpMessageFactory.prototype.createHttpResponseMessage = function({ fromHost, data, headers, messageStatus }) {}
