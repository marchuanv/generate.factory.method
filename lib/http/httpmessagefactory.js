...
function HttpMessageFactory({ messageFactory }) {
    ...
    Object.defineProperty(this, 'createHttpRequestMessage', { writable: false, value: ({ data, headers, messageStatus }) => {
...
HttpMessageFactory.prototype.createHttpRequestMessage = function({ data, headers, messageStatus }) {}
