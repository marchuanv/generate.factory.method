...
function HttpRequestMessage({ message }) {
    ...
    Object.defineProperty(this, 'getAddress', { writable: false, value: () => {
    ...
    Object.defineProperty(this, 'validate', { writable: false, value: () => {
        ...
        if (!(this.getAddress())) {
            throw new Error("http request message requires a valid address");
        }
        if (!(this.getTimeout())) {
...
HttpRequestMessage.prototype.getAddress = () => {};
