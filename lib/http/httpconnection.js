...
async function waitForClientHttpRequests({ httpClientMessageQueue, timeout, isOpen }) {
    console.log(`HttpConnection Client: Waiting To Dequeue The Next Http Request Message`);
    const { httpRequestMessage } = await httpClientMessageQueue.dequeueHttpRequestMessage();
    console.log(`HttpConnection Client: Dequeued An Http Request Message`);
    ...
    console.log(`HttpConnection Client: Http Request Sent`);
        ...
        return new Promise((resolve) => {
            ...
            server.on("request", async (httpRequest, httpResponse) => {
                ...
                httpRequest.on('end', async () => {
                    ...
                    console.log(`HttpConnection Server: Http Response Written`);
                });
            });
