...
function HttpConnection({ httpRequestQueue }) {
    ...
    let server;
    Object.defineProperty(this, 'send', { writable: false, value: ({ address, path, headers, method, timeout, data }) => {
    ...
    Object.defineProperty(this, 'open', { writable: false, value: ({ address, timeout }) => {
        return new Promise((resolve) => {
            const optionsStr = utils.getJSONString({ address });
...
HttpConnection.prototype.send = function({ address, path, headers, method, timeout, data }) { };
HttpConnection.prototype.open = function({ address, timeout }) { };
