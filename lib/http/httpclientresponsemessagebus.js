...
function HttpClientResponseMessageBus({ scopeId, messageQueueBinder, messageQueue }) {
    ...
    Object.defineProperty(this, 'subscribe', { configurable: false, writable: false, value: ({ callback }) => {
        messageQueue.dequeueMessage({ queueName: httpClientResponseQueueName }).then( async ({ message }) => {
