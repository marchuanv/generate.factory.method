        ...
        if (unresolved) {
            {
                ...
                parentContainerInfo.childContainerInfoArray[unresolvedChildContainerInfoIndex] = resolveContainerInfo({ typeName, isContextSingleton, containerFilePath, prototypeScriptPath, typeInfo, containerInfoFilePath, typeInfoFilePath });
            }
        }
    };
