...
function Message({ Id, messageContent, messageContentMetadata, messageMetadata, messageStatus }) {
    ...
    Object.defineProperty(this, 'getSenderAddress', { configurable: false, writable: false, value: () => {
        ...
        return createSenderAddress({ senderHost: senderhost, senderPort: senderport });
    }});
    Object.defineProperty(this, 'getRecipientAddress', { configurable: false, writable: false, value: () => {
        ...
        return createRecipientAddress({ recipientHost: recipienthost, recipientPort: recipientport });
    }});
