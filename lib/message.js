...
Message.prototype.constructor = function({ 
    ...
    Object.defineProperty(this, 'getSenderAddress', { configurable: false, writable: false, value: () => {
        ...
        return createSenderAddress({ factoryContainerBindingName, senderHost: senderhost, senderPort: senderport });
    }});
    Object.defineProperty(this, 'getRecipientAddress', { configurable: false, writable: false, value: () => {
        ...
        return createRecipientAddress({ factoryContainerBindingName, recipientHost: recipienthost, recipientPort: recipientport });
    }});
