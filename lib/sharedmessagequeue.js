...
function SharedMessageQueue() {
    ...
    Object.defineProperty(this, 'bind', { configurable: false, writable: false, value: ({ messageQueueType }) => {
        console.log(`binding ${messageQueueType} queue.`);
    ...
    Object.defineProperty(this, 'unbind', { configurable: false, writable: false, value: ({ messageQueueType }) => {
        console.log(`unbinding ${messageQueueType} queue.`);
        delete bindings[messageQueueType];
    }});
    Object.defineProperty(this, 'isBind', { configurable: false, writable: false, value: ({ messageQueueType }) => {
        return bindings[messageQueueType] !== undefined && bindings[messageQueueType] !== null;
    }});
};
...
SharedMessageQueue.prototype.isBind = function ({ messageQueueType }) { };
