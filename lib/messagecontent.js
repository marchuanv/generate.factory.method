function MessageContent({ data, sharedUserSessions, messageMetadata, messageContentMetadata }) {
    ...
    if (userSecurity.isAuthorised()) {
        ...
        Object.defineProperty(this, 'getDecryptedData', { configurable: false, writable: false, value: decryptedData });
        Object.defineProperty(this, 'getEncryptedData', { configurable: false, writable: false, value: encryptedData });
