...
const { MessageContent } = require("./messagecontent.prototype");
MessageContent.prototype.constructor = function({ data, userSessions, messageMetadata, messageContentMetadata }) {
