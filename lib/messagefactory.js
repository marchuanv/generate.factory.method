...
function MessageFactory(encryption) {
    const messages = [];
    Object.defineProperty(this, 'create', { writable: false, value: ({ recipientAddress, data, metadata, messageStatus }) => {
...
MessageFactory.prototype.create = function({ recipientAddress, data, metadata, messageStatus }) {}
