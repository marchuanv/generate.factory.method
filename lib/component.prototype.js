function Component({ contextName, clientMessageBus, serverMessageBus, userSessions, packageJson }) {
    this.constructor({ contextName, clientMessageBus, serverMessageBus, userSessions, packageJson });
};
