function Subscription({ channelName }) {
    ...
    const callbacks = [];    
    Object.defineProperty(this, 'getChannelName', { writable: false, value: () => channelName });
    Object.defineProperty(this, 'receiveData', { writable: false, value: ({ from, data }) => {
        for(const callback of callbacks) {
            callback({ from, data });
        };
    }});
    Object.defineProperty(this, 'onDataReceived', { writable: false, value: ({ callback }) => {
