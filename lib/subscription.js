function Subscription({ channelName }) {
    ...
    const callbacks = [];    
    Object.defineProperty(this, 'getChannelName', { configurable: true, writable: false, value: () => channelName });
    Object.defineProperty(this, 'receiveData', { configurable: true, writable: false, value: ({ from, data }) => {
