...
function MessageBus({ messageHandler, subscriptionFactory, errorMessages }) {
    ...
    Object.defineProperty(this, 'subscribe', { writable: false, value: async ({ channelName, callback }) => {
      subscriptionFactory.get({ channelName }).onDataReceived({ callback });
    }});
    Object.defineProperty(this, 'publish', { writable: false, value: ({ channelName, data }) => { //fire and forget
      messageHandler.send({ data: { data, channelName } });
    }});
};
