...
function MessageHandler({ httpMessageHandler, webSocketMessageHandler, httpMessageFactory, webSocketMessageFactory, errorMessages }) {
    ...
    if (httpMessageHandler) {
        Object.defineProperty(this, 'send', { writable: false, value: async ({ data }) => {
            const httpResponseMessage = await httpMessageHandler.send({ data });
        ...
        Object.defineProperty(this, 'send', { writable: false, value: async ({ data }) => {
            return await webSocketMessageHandler.send({ data });
        }});
        Object.defineProperty(this, 'receive', { writable: false, value: ({ callback }) => {
...
MessageHandler.prototype.send = async function({ data }) { };
