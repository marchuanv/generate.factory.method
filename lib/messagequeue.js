...
function MessageQueue({ userId }) {
    ...
    Object.defineProperty(this, 'enqueueHttpRequestMessage', { configurable: false, writable: false, value: ({ httpRequestMessage, httpRequest }) => {
        if (httpRequest) {
            const { httpRequestMessage } = createHttpRequestMessage({
    ...
    Object.defineProperty(this, 'enqueueHttpResponseMessage', { configurable: false, writable: false, value: ({ httpResponseMessage, httpResponse }) => {
        if (httpResponse) {
            const { httpResponseMessage } = createHttpResponseMessage({
                userId,
...
MessageQueue.prototype.enqueueHttpRequestMessage = function({ httpRequestMessage, httpRequest }) { };
MessageQueue.prototype.enqueueHttpResponseMessage = function({ httpResponseMessage, httpResponse }) { };
