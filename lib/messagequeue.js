...
function MessageQueue({ logger }) {
    ...
    Object.defineProperty(this, 'bind', { configurable: false, writable: false, value: ({ bindingObj }) => {
        Object.defineProperty(bindingObj, 'queueMessage', { configurable: false, writable: false, value: async ({ message }) => {
            this.queueMessage({ message, queueName });
        }});
        Object.defineProperty(bindingObj, 'dequeueMessage', { configurable: false, writable: false, value: () => {
            this.dequeueMessage({ queueName });
        }});
        Object.defineProperty(bindingObj, 'peekMessage', { configurable: false, writable: false, value: () => {
