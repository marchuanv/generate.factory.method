...
function MessageQueue({ userId }) {
    ...
    Object.defineProperty(this, 'enqueueRawHttpResponse', { configurable: false, writable: false, value: ({ headers, data }) => {
        ...
        requestMessages.push(httpResponseMessage);
...
MessageQueue.prototype.enqueueRawHttpResponse = function({ headers, data }) { };
