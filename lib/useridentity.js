...
function UserIdentity({ userId }) {
    ...
    Object.defineProperty(this, 'register', { configurable: false, writable: false, value: ({ secret }) => {
        if (secret) {
            ...
            const base64RSAPrivateKey = utils.stringToBase64(privateKey);
            const base64RSAPublicKey = utils.stringToBase64(publicKey);
            user = { hashedPassphrase, hashedPassphraseSalt, base64RSAPrivateKey, base64RSAPublicKey };
    ...
    Object.defineProperty(this, 'getBase64KeyPair', { configurable: false, writable: false, value: () => {
        const { base64RSAPrivateKey, base64RSAPublicKey } = user || {};
