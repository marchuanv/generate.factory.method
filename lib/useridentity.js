...
function UserIdentity({ userId }) {
    ...
    Object.defineProperty(this, 'getHashedPassphraseSalt', { configurable: false, writable: false, value: () => {
        return user.hashedPassphraseSalt;
    }});
    ...
    Object.defineProperty(this, 'getBase64KeyPair', { configurable: false, writable: false, value: ({ isBase64Format }) => {
        const { privateKeyBase64, publicKeyBase64 } = user;
        return { privateKeyBase64, publicKeyBase64 };
    }});
    Object.defineProperty(this, 'getKeyPair', { configurable: false, writable: false, value: ({ isBase64Format }) => {
        const { privateKeyBase64, publicKeyBase64 } = user;
