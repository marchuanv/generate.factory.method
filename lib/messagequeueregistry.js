function MessageQueueRegistry({ factoryContainer }) {
    const HttpClientMessageBusBinding = require('./binding/httpclientmessagebusmessagequeuebinding.js');
    const HttpClientMessageBusManagerBinding = require('./binding/httpclientmessagebusmanagermessagequeuebinding.js');
