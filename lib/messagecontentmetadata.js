...
const { createContentType } = require('./factory/generated/contenttype/contenttype.factory.js');
const { MessageContentMetadata } = require("./messagecontentmetadata.prototype");
MessageContentMetadata.prototype.constructor = function({ contextName, data }) {
    ...
    let { contentType } = createContentType({ contextName, name });
    ...
    Object.defineProperty(this, 'setContentType', { configurable: false, writable: false, value: ({ name }) => contentType = createContentType({ contextName, name }) });
}
