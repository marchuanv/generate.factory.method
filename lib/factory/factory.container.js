...
function FactoryContainer({ bindingName, typeName,  typeVariableName, scriptPath, isSingleton, bindingFilePath, defaultBindingFilePath, ctorParameters }) {
        ...
        for (const argName of Object.keys(_ctorArguments)) {
            let depContainer = null;
            {
                ...
                if (bindingFilePath) {
                    ...
                    bindingFilePath: bindings[factoryContainerBindingName], defaultBindingFilePath: bindings['Default']
                    depContainer = factory.getContainer({ bindingFilePath: containerBinding });
                } 
            }            
            if (depContainer) {
