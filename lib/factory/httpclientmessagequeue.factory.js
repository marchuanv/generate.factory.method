...
function createHttpClientMessageQueue({recipientHost,recipientPort,messageQueueTypeCode,isSyncedMessageQueueTypes,userId,senderHost,senderPort}) {
    let factoryContainer = new FactoryContainer();
    factoryContainer.add({recipientHost,recipientPort,messageQueueTypeCode,isSyncedMessageQueueTypes,userId,senderHost,senderPort});
