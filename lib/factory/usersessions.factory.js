...
const { UserSessionsFactoryContainer } = require('C:\\component\\lib\\factory\\usersessions.factory.container.json');
const factory = new Factory(UserSessionsFactoryContainer);
