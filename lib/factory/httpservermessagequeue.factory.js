...
* @param {recipientHost,recipientPort,messageQueueTypeArray,userId,senderHost,senderPort}
*/
function createHttpServerMessageQueue({recipientHost,recipientPort,messageQueueTypeArray,userId,senderHost,senderPort}) {
    const container = factory.createContainer({ type: HttpServerMessageQueue, variableName:'httpServerMessageQueue', singleton: false });
    container.config({recipientHost,recipientPort,messageQueueTypeArray,userId,senderHost,senderPort});
