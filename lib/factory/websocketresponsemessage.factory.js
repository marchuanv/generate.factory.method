...
*/
function createWebSocketResponseMessage({factoryContainerBindingName,messageStatusCode,Id,data,recipientHost,recipientPort,metadata,token,senderHost,senderPort}) {
