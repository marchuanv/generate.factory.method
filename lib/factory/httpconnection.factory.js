...
function createHttpConnection({timeout,recipientHost,recipientPort,isSyncedMessageQueueTypes,messageQueueTypeCode,userId,senderHost,senderPort}) {
    let factoryContainer = new FactoryContainer();
    factoryContainer.add({timeout,recipientHost,recipientPort,isSyncedMessageQueueTypes,messageQueueTypeCode,userId,senderHost,senderPort});
