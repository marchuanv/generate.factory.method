...
* @param {timeout,recipientHost,recipientPort,messageQueueTypeArray,userId,senderHost,senderPort}
*/
function createHttpConnection({timeout,recipientHost,recipientPort,messageQueueTypeArray,userId,senderHost,senderPort}) {
    const container = factory.createContainer({ type: HttpConnection, variableName:'httpConnection', singleton: false });
    container.config({timeout,recipientHost,recipientPort,messageQueueTypeArray,userId,senderHost,senderPort});
