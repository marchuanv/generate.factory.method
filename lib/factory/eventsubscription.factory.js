...
* @param {messageQueueContextId,eventDescription,eventCode,eventSource,subscriptionName}
*/
function createEventSubscription({messageQueueContextId,eventDescription,eventCode,eventSource,subscriptionName}) {
    const container = factory.createContainer({ type: EventSubscription, variableName:'eventSubscription', singleton: false });
    container.config({messageQueueContextId,eventDescription,eventCode,eventSource,subscriptionName});
