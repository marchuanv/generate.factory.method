...
const { HttpServerStartMessageQueueBindingFactoryContainer } = require('C:\\component\\lib\\factory\\httpserverstartmessagequeuebinding.factory.container.json');
const factory = new Factory(HttpServerStartMessageQueueBindingFactoryContainer);
