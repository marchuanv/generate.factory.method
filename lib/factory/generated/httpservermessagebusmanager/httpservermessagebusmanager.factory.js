...
function createHttpServerMessageBusManager({factoryContainerBindingName}) {
    ...
    const containerBinding = require(`C://component//lib//factory//generated//httpservermessagebusmanager//httpservermessagebusmanager.factory.container.multiplerequestsspec.binding.json`);
