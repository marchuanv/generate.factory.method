...
*/
function createWebSocketResponseMessage({messageStatusCode,contextName,data,recipientHost,recipientPort,metadata,token,senderHost,senderPort,factoryContainerBindingName}) {
    const bindings = {
