...
/**
* Create Component
* @param {packageJson,contextName,factoryContainerBindingName}
*/
function createComponent({packageJson,contextName,factoryContainerBindingName}) {
    const bindings = {
    ...
    return container.getInstance({ ctorArgs: {packageJson,contextName} });
}
