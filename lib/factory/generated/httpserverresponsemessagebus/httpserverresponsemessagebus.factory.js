...
function createHttpServerResponseMessageBus({factoryContainerBindingName}) {
    ...
    const containerBinding = require(`C://component//lib//factory//generated//httpserverresponsemessagebus//httpserverresponsemessagebus.factory.container.${_factoryContainerBindingFileName}.binding.json`);
