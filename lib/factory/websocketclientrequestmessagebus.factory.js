...
const { WebSocketClientRequestMessageBusFactoryContainer } = require('C:\\component\\lib\\factory\\websocketclientrequestmessagebus.factory.container.json');
const factory = new Factory(WebSocketClientRequestMessageBusFactoryContainer);
