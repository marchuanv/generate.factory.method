...
function createMessageBus({token,userId,recipientHost,recipientPort,senderHost,senderPort,data,metadata,messageStatusCode,channelName}) {
    let factoryContainer = new FactoryContainer();
    factoryContainer.add({token,userId,recipientHost,recipientPort,senderHost,senderPort,data,metadata,messageStatusCode,channelName});
...
factoryContainer.add(createMessageHandler({token,userId,recipientHost,recipientPort,senderHost,senderPort}));
