...
function createMessageBus({token,recipientHost,recipientPort,userId,senderHost,senderPort,data,metadata,messageStatusCode,channelName}) {
    ...
    factoryContainer.add({token,recipientHost,recipientPort,userId,senderHost,senderPort,data,metadata,messageStatusCode,channelName});
...
factoryContainer.add(createMessageHandler({token,recipientHost,recipientPort,userId,senderHost,senderPort}));
