...
*/
function createMessageBus({recipientHost,recipientPort,Id,userId,data,senderHost,senderPort,token,metadata,messageStatusCode,channelName}) {
...
container.config(createMessageHandlerQueue({}));
    container.complete();
