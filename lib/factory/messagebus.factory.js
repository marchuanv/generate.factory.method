...
function createMessageBus({token,messageQueueTypeCode,recipientHost,recipientPort,userId,senderHost,senderPort,data,metadata,messageStatusCode,channelName}) {
    ...
    factoryContainer.add({token,messageQueueTypeCode,recipientHost,recipientPort,userId,senderHost,senderPort,data,metadata,messageStatusCode,channelName});
...
factoryContainer.add(createMessageHandler({token,messageQueueTypeCode,recipientHost,recipientPort,userId,senderHost,senderPort}));
