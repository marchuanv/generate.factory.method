...
function createMessageBus({token,messageQueueTypeCode,messageQueueArray,recipientHost,recipientPort,userId,senderHost,senderPort,data,metadata,messageStatusCode,channelName}) {
    let factoryContainer = new FactoryContainer();
    factoryContainer.add({token,messageQueueTypeCode,messageQueueArray,recipientHost,recipientPort,userId,senderHost,senderPort,data,metadata,messageStatusCode,channelName});
...
factoryContainer.add(createMessageHandler({token,messageQueueTypeCode,messageQueueArray,recipientHost,recipientPort,userId,senderHost,senderPort}));
