...
function createMessageBus({userId,senderHost,senderPort,recipientHost,recipientPort,data,token,metadata,messageStatusCode,channelName}) {
    let factoryContainer = new FactoryContainer();
    factoryContainer.add({userId,senderHost,senderPort,recipientHost,recipientPort,data,token,metadata,messageStatusCode,channelName});
