...
function Factory({ typeName, typeVariableName, scriptPath, isSingleton, bindings }) {
    Object.defineProperty(this, 'getInstance', { configurable: false, writable: false, value: ({ factoryContainerBindingName, ctorArgs }) => {
        ...
        console.log(`creating an instance of ${typeName} using ${factoryContainerBindingName} binding configuration.`);
        ...
        binding.instances[typeVariableName] = new Type(_ctorArgs);
        result[typeVariableName] =binding.instances[typeVariableName];
