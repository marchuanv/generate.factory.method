...
function createMessageHandler({token,isSyncedMessageQueueTypes,messageQueueTypeCode,recipientHost,recipientPort,userId,senderHost,senderPort}) {
    let factoryContainer = new FactoryContainer();
    factoryContainer.add({token,isSyncedMessageQueueTypes,messageQueueTypeCode,recipientHost,recipientPort,userId,senderHost,senderPort});
...
factoryContainer.add(createHttpMessageHandler({isSyncedMessageQueueTypes,messageQueueTypeCode,recipientHost,recipientPort,userId,senderHost,senderPort}));
