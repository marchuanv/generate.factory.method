...
function createMessageHandler({token,recipientHost,recipientPort,userId,senderHost,senderPort}) {
    ...
    factoryContainer.add({token,recipientHost,recipientPort,userId,senderHost,senderPort});
...
factoryContainer.add(createHttpMessageHandler({recipientHost,recipientPort,userId,senderHost,senderPort}));
