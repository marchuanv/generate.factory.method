...
function createMessageHandler({token,messageQueueTypeCode,messageQueueArray,recipientHost,recipientPort,userId,senderHost,senderPort}) {
    let factoryContainer = new FactoryContainer();
    factoryContainer.add({token,messageQueueTypeCode,messageQueueArray,recipientHost,recipientPort,userId,senderHost,senderPort});
...
factoryContainer.add(createHttpMessageHandler({messageQueueTypeCode,messageQueueArray,recipientHost,recipientPort,userId,senderHost,senderPort}));
