...
function createMessageHandler({token,userId,recipientHost,recipientPort,senderHost,senderPort}) {
    let factoryContainer = new FactoryContainer();
    factoryContainer.add({token,userId,recipientHost,recipientPort,senderHost,senderPort});
...
factoryContainer.add(createHttpMessageHandler({userId,recipientHost,recipientPort,senderHost,senderPort}));
