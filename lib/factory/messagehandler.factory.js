...
function createMessageHandler({userId,timeout,host,port}) {
    let factoryContainer = new FactoryContainer();
    factoryContainer.add({userId,timeout,host,port});
    factoryContainer.add(createWebSocketMessageHandler({timeout,host,port}));
