...
function createMessageHandler({token,messageQueueTypeCode,recipientHost,recipientPort,userId,senderHost,senderPort}) {
    ...
    factoryContainer.add({token,messageQueueTypeCode,recipientHost,recipientPort,userId,senderHost,senderPort});
...
factoryContainer.add(createHttpMessageHandler({messageQueueTypeCode,recipientHost,recipientPort,userId,senderHost,senderPort}));
