...
function createMessage({senderHost,senderPort,userId,data,token,messageStatusCode}) {
    let factoryContainer = new FactoryContainer();
    factoryContainer.add({senderHost,senderPort,userId,data,token,messageStatusCode});
...
factoryContainer.add(createMessageContent({userId,data,senderHost,senderPort,token}));
