...
*/
function createMessage({messageStatusCode,Id,data,recipientHost,recipientPort,metadata,userId,senderHost,senderPort}) {
...
container.config(createMessageContent({data,recipientHost,recipientPort,metadata,userId,senderHost,senderPort}));
