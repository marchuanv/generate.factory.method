...
*/
function createMessage({recipientHost,recipientPort,Id,userId,data,metadata,messageStatusCode,senderHost,senderPort}) {
...
container.config(createMessageContent({userId,data}));
