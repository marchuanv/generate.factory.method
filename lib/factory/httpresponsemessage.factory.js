...
*/
function createHttpResponseMessage({factoryContainerBindingName,messageStatusCode,Id,data,recipientHost,recipientPort,metadata,token,senderHost,senderPort}) {
